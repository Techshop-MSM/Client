                            ...
                            <table class="table">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>4x SATA 6G<br/>
                                        1x M.2 (PCIe 4.0 x4, 2260, 2280, CPU)<br/>
                                        1x M.2 (PCIe 4.0 x4, 2242-2280, Chipsatz)<br/>
                                        1x USB-C (ein Header, USB 3.2 Gen 2, max. 10 Gbit/s)<br/>
                                        2x USB 3.0 (ein Header, USB 3.2 Gen 1, max. 5 Gbit/s)<br/>
                                        2x USB 2.0 (ein Header, max. 480 Mbit/s)<br/>
                                        1x Front Panel Audio Header (AAFP)<br/>
                                        1x S/PDIF Out Header<br/>
                                        1x Speaker Header 1x 10-1 pin System Panel Header<br/>
                                        1x Clear CMOS Header</td><br/>
                                  </tr>
                                  <tr>
                                    <td>Lüfter-Header:</td>
                                    <td>1x CPU-Fan (4-Pin)<br/>
                                        1x CPU-Fan OPT (4-Pin)<br/>
                                        1x Pumpe (4-Pin)</td>
                                  </tr>
                                  <tr>
                                    <td>Externe Anschlüsse:</td>
                                    <td>1x USB 3.2 Typ C (USB 3.2 Gen 2x2, max. 20 Gbit/s)<br/>
                                        1x USB 3.0 Typ C (USB 3.1 Gen 1, max. 5 Gbit/s)<br/>
                                        3x USB 3.0 Typ A (USB 3.1 Gen 1, max. 5 Gbit/s)<br/>
                                        3x USB 2.0 (max. 480 Mbit/s)<br/>
                                        1x DisplayPort 1.4<br/>
                                        1x HDMI 2.1<br/>
                                        2x WLAN-Antenne (WiFi 6, WLAN ax, 2x2, Bluetooth 5.2)<br/>
                                        1x RJ-45 (Intel I225-V, max. 2,5 Gbit/s)<br/>

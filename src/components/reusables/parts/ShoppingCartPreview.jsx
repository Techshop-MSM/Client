    ...
    <>
      ...
      <Offcanvas show={show} onHide={handleClose}>
        ...
        <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td><img width="50"
                                    ...
                                    alt=""/></td>
                            <td style={{fontSize: '10px'}}>Gaming PC Survivalist Powered by MSI, Intel i5-12400F, RTX 3070
                                Ti </td>
                            <td><select class="form-select-sm" aria-label="Default select example">
                ...
                <button type="button" class="btn btn-primary btn-sm">Warenkorb öffnen</button>
                <button type="button" class="btn btn-secondary btn-sm">Zur Kasse</button>
        </Offcanvas.Body>
      </Offcanvas>
    </>
  );

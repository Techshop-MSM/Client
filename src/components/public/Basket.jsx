            ...
            <Row>
                ...
                <ListGroup>
                    ...
                    <Form style={{ display: 'inlineBlock' }}>
                      {['radio'].map((type) => (
                        <div key={`default-${type}`} className="mb-3">
                          <Form.Check type={type} id={`default-${type}`} label={`DHL Standard`} />
                        </div>
                      ))}
                    </Form>
                  ...
                  <ListGroup.Item>
                    <Form style={{ display: 'inlineBlock' }}>
                      {['radio'].map((type) => (
                        <div key={`default-${type}`} className="mb-3">
                          <Form.Check type={type} id={`default-${type}`} label={`DHL Express`} />
                        </div>
                      ))}
                    </Form>
                  ...
                  <ListGroup.Item>
                    <Form style={{ display: 'inlineBlock' }}>
                      {['radio'].map((type) => (
                        <div key={`default-${type}`} className="mb-3">
                          <Form.Check type={type} id={`default-${type}`} label={`GLS Standard`} />
                        </div>
                      ))}
                    </Form>
                  ...
                  <ListGroup.Item>
                    <Form style={{ display: 'inlineBlock' }}>
                      {['radio'].map((type) => (
                        <div key={`default-${type}`} className="mb-3">
                          <Form.Check type={type} id={`default-${type}`} label={`UPS Standard`} />
                        </div>
                      ))}
                    </Form>
              ...
              <Col lg={6}>
                ...
                <ListGroup.Item>
                  <Form style={{ display: 'inlineBlock' }}>
                    {['radio'].map((type) => (
                      <div key={`default-${type}`} className="mb-3">
                        <Form.Check type={type} id={`default-${type}`} label={`Vorkasse`} />
                      </div>
                    ))}
                  </Form>
                  <p style={{ display: 'inline' }}>
                    Sie zahlen einfach vorab und erhalzten die Ware bequem und ohne weitere GEbühren
                    bei Zahlungseingang nach Hause geliefert. Hier finden Sie unsere Bankverbindung
                  </p>
                </ListGroup.Item>
                ...
                <ListGroup.Item>
                  <Form style={{ display: 'inlineBlock' }}>
                    {['radio'].map((type) => (
                      <div key={`default-${type}`} className="mb-3">
                        <Form.Check type={type} id={`default-${type}`} label={`Kreditkarte`} />
                      </div>
                    ))}
                  </Form>
                </ListGroup.Item>
                ...
                <ListGroup.Item>
                  <Form style={{ display: 'inlineBlock' }}>
                    {['radio'].map((type) => (
                      <div key={`default-${type}`} className="mb-3">
                        <Form.Check type={type} id={`default-${type}`} label={`Amazon Pay`} />
                      </div>
                    ))}
                  </Form>
                </ListGroup.Item>
                ...
                <ListGroup.Item>
                  <Form style={{ display: 'inlineBlock' }}>
                    {['radio'].map((type) => (
                      <div key={`default-${type}`} className="mb-3">
                        <Form.Check type={type} id={`default-${type}`} label={`PayPal`} />
                      </div>
                    ))}
                  </Form>
                </ListGroup.Item>
              ...
              <Container fluid>
                <Row>
                  ...
                  <Col lg={12}>
                    <p>
                      Mit Klick auf "Zahlungspflichtig bezahlen" akzeptierst du unsere AGB und
                      bestätigst, dass du für private Zwecke bestellst und mit der GEltung unserer
                      Widerrufsbelehrung einverstanden bist.
                    </p>
                    <button className="bg-success" style={{ float: 'right' }}>

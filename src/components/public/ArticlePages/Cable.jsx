  ...
  return (
    <>
      <div className="container">
        <CableFilter />
        <div className="row">
          <div className="col-lg-3" style={{ minHeight: '600px', marginBottom: '30px' }}>
            <div className="cardcontainer">
              ...
              <div className="content">
                ...
                <p className="txt2">
                  Dieses Mainboard vereint Design gepart mit Roher Leistung welche vor allem in der
                  Gamerzene immerwieder für Topleistungen führt.
                </p>
              </div>
